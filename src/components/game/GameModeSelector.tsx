        ...
        <div className="grid gap-4 mt-4">
          ...
          >
            ...
            <p className="text-sm text-gray-300 mt-1">
              Classic gameplay with gradually increasing difficulty.
              Clear matching rows and columns to score points.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-sm text-gray-300 mt-1">
              Faster timer, higher score multipliers, and special pieces.
